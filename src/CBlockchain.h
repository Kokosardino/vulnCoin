...
public:
    ...
    /**
     * Find index of the block a specified transaction is embedded in.
     * @param txid Transaction ID of the searched transactions.
     * @return Block index if the transaction is found. -1 is returned otherwise.
     */
