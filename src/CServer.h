...
public:
    ...
    */
     ...
     * @return vulnCoin address of the validator of the next block.
     */
    std::string countNextValidator();

    /**
     * Count the index of the next block validator with respect to coin ages.
     * @return
     */
    ...
    /**
     * Print stakepool contents with respect to their coin age.
     * @param stakepool Pool of stakes.
     * @return Printable string of contents of the stakepool.
     */
